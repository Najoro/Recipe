 ...
 */
final class Version20240817182934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe CHANGE cetgory_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe CHANGE category_id cetgory_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE recipe ADD CONSTRAINT FK_DA88B1375C2203FB FOREIGN KEY (cetgory_id) REFERENCES category (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
